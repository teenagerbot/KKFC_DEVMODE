...
document.querySelector('#__ADD').onclick = () => {
  for (let c = 0; c < 4; c++) {
    ...
    TR.innerHTML = /*html*/ `<td>${++OPERA}</td>
                  <td contenteditable="${c == 2 ? 'false' : 'true'}" namer="${
      c == 0
        ? 'Назва дії'
        : c == 1
        ? 'Інструмент'
      ...
      c == 3
        ...
        : ''
                  ...
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : "tar='ПИ'"
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="D,B"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="L"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="t"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="i"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="S"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="n"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="V"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="H"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="Y"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="X"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="E"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="F"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="h"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="R"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="d"'
                  }></td>
                  <td contenteditable="true" ${
                    c != 3 ? "class='hidene'" : 'tar="Z"'
                  }></td>
                  ${
                    c == 0
...
function readerJSON(object, napryam = 'next') {
  ...
  perehods.forEach((perehid) => {
    //FIXME - READING FROM LOCALSTORAGE
    const TR = document.createElement('tr');
    const TR1 = document.createElement('tr');
    const TR2 = document.createElement('tr');
    const TR3 = document.createElement('tr');
    TR.innerHTML = /*html*/ `<td>${napryam == 'prev' ? ++OPERA : --OPERA}</td>
                    <td contenteditable="true" namer="Назва дії" window="wind">${String(perehid).replace(/(\d+) \_INDEX\_FOR\_REPLACE\_/i, "")}</td>
    ...
    TR1.innerHTML = /*html*/ `<td>${napryam == 'prev' ? ++OPERA : --OPERA}</td>
                    <td contenteditable="true" namer="Інструмент" class="instrument">${
                      cont.Переходи[perehid]['Інструмент']
                    }</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
    ...
    TR2.innerHTML = /*html*/ `<td>${napryam == 'prev' ? ++OPERA : --OPERA}</td>
                    <td contenteditable="true" namer="Вимірювальний інструмент" class="vim">${
                      cont.Переходи[perehid]['Вимірювальний інструмент']
                    }</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
    ...
    TR3.innerHTML = `<td>${napryam == 'prev' ? ++OPERA : --OPERA}</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" tar="ПИ">${
                      cont.Переходи[perehid].data['ПІ']
                    }</td>
                    <td contenteditable="true" tar="D,B">${
                      cont.Переходи[perehid].data['D або B']
                    }</td>
                    <td contenteditable="true" tar="L">${
                      cont.Переходи[perehid].data.L
                    }</td>
                    <td contenteditable="true" tar="t">${
                      cont.Переходи[perehid].data.t
                    }</td>
                    <td contenteditable="true" tar="i">${
                      cont.Переходи[perehid].data.i
                    }</td>
                    <td contenteditable="true" tar="S">${
                      cont.Переходи[perehid].data.S
                    }</td>
                    <td contenteditable="true" tar="n">${
                      cont.Переходи[perehid].data.n
                    }</td>
                    <td contenteditable="true" tar="V">${
                      cont.Переходи[perehid].data.V
                    }</td>
                    <td contenteditable="true" tar="H">${
                      cont.Переходи[perehid].data.H
                    }</td>
                    <td contenteditable="true" tar="Y">${
                      cont.Переходи[perehid].data.Y
                    }</td>
                    <td contenteditable="true" tar="X">${
                      cont.Переходи[perehid].data.X
                    }</td>
                    <td contenteditable="true" tar="E">${
                      cont.Переходи[perehid].data.E
                    }</td>
                    <td contenteditable="true" tar="F">${
                      cont.Переходи[perehid].data.F
                    }</td>
                    <td contenteditable="true" tar="h">${
                      cont.Переходи[perehid].data.h
                    }</td>
                    <td contenteditable="true" tar="R">${
                      cont.Переходи[perehid].data.R
                    }</td>
                    <td contenteditable="true" tar="d">${
                      cont.Переходи[perehid].data.d
                    }</td>
                    <td contenteditable="true" tar="Z">${
                      cont.Переходи[perehid].data.Z
                    }</td>`;
    document.querySelector('table').appendChild(TR);
...
function readerJSONStatic(object) {
  ...
  perehods.forEach((perehid) => {
    ...
    const TR3 = document.createElement('tr');
    TR.innerHTML = /*html*/ `<td>${++OPERA}</td>
                    <td contenteditable="true" namer="Назва дії" placeholder="Назва дії" window="wind">${String(perehid).replace(/(\d+) \_INDEX\_FOR\_REPLACE\_/i, "")}</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
    ...
    TR1.innerHTML = /*html*/ `<td>${++OPERA}</td>
                    <td contenteditable="true" namer="Інструмент" placeholder="Інструмент" class="instrument">${
                      cont.Переходи[perehid]['Інструмент']
                    }</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
    ...
    TR2.innerHTML = /*html*/ `<td>${++OPERA}</td>
                    <td contenteditable="true" namer="Вимірювальний інструмент" placeholder="Вимірювальний інструмент" class="vim">${
                      cont.Переходи[perehid]['Вимірювальний інструмент']
                    }</td>
                    <td contenteditable="true" class="hidene"></td>
                    <td contenteditable="true" class="hidene"></td>
...
document.querySelector('#__next').onclick = () => {
  ...
  // const elems = Array.from(document.querySelectorAll(".menu_item"));
  // const elms = [];
  // elems.forEach(el => {
  //   elms.push(el.innerText)
  // })
  // if (!elms.includes(String(document.querySelector("h1").innerText))) {
  //   const P = document.createElement("p");
